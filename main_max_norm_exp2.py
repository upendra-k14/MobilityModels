...
def performance_over_transmission_range():
    """
    Function to analyze performance of model over different values
    of TRANSMISSION_RANGE
    """
    ...
    for j in range(100, 301, 20):
        ...
        aggregate_performance_param(time.time()-INIT_TIME)
        print("\n")


if __name__ == "__main__":

    performance_over_transmission_range()
